...
def create_teaser_pdf(ratios, diagnosis, rev_sim, margin_sim):
    ...
    # Using explicit width 180 instead of 0 to prevent horizontal space errors
...
if uploaded_file:
    try:
        ...
        st.error(f"⚠️ Error processing file. Ensure strict template format. Details: {str(e)}")    except: return False
